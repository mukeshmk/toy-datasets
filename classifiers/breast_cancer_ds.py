...
f = fml()
# f._jprint(f.publish(model, "Accuracy", acc, str(cancer.data)))

# f.publish(model, "Accuracy", acc, str(cancer.data))

# f._jprint(f.retrieve_all_metrics(str(cancer.data)))

f._jprint(f.retrieve_best_metric(str(cancer.data), False))